...
;ST_RDM	EQU	15	
ST_WM	EQU	16	; Set if in H2RG windowing = subarray readout mode
ST_RST	EQU	17	; Set if resetting the H2RG array
ST_DIRTY EQU	18	; Set if any readout parameters have been changed
